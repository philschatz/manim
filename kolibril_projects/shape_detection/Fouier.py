...
class CustomFourierSceneC(FourierOfPiSymbol):
    CONFIG = {
        "n_vectors": 3,
        "run_time": 100,
        "start_drawn": True,
        "file_name": "ellipses/no9.svg",
        "height": 2,
    }
...
if __name__ == "__main__":
    ...
    os.system(f"manim  -s  --custom_folders  --disable_caching   -p  -c 'BLACK' --config_file '{project_path}/manim_settings.cfg' " + script_name + " CustomFourierSceneC")
